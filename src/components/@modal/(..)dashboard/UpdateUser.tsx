...
async function updateUser(
  ...
  try {
    await axios.patch(`${process.env.NEXT_PUBLIC_API}/user/${userId}`, {
...
export default function UpdateUserForm({
  ...
  useEffect(() => {
    (async () => {
      setUser(await getUserDetail(userId, setOpenError));
    })();
  }, []);
                  ...
                  <div className="isolate bg-white px-6 py-5 sm:py-12 lg:px-8">
                    ...
                    <div className="mx-auto max-w-xl text-center">
                      ...
                      <p className="mt-2 text-base leading-8 text-gray-600">
                        You can click confirm down below to submit the changes
                      </p>
                    </div>
                    {user.email !== "" && (
                      <Formik
